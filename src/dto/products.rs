...
//     pub(crate) fn builder() -> PriceQueryParamsBuilder {
...
//             let response = ProductOverviewResponse { products, total: 2 };
...
//             assert_eq!(
//                 comparison.yesterday_min_price,
//                 deserialized.yesterday_min_price
//             );
//             assert_eq!(
//                 comparison.yesterday_avg_price,
//                 deserialized.yesterday_avg_price
//             );
//             assert_eq!(
//                 comparison.yesterday_max_price,
//                 deserialized.yesterday_max_price
//             );
//         }
