...
use crate::services::orders::common::{get_dashboard_stats, get_exchange_and_return_order_details_by_order_code, get_order_by_order_code, get_orders};
...
pub(super) fn common_routes() -> Router {
    Router::new()
        ...
        .route(
            "/dashboard-stats",
            get(get_dashboard_stats::<MySqlRepository>),
        )
}
